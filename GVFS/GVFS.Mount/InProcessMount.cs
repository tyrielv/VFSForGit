    ...
    public class InProcessMount
    {
        ...
        private void EnsureLocalCacheIsHealthy(ServerGVFSConfig serverGVFSConfig)
        {
            ...
            if (Directory.Exists(this.enlistment.GitObjectsRoot))
            {
                ...
                string alternatesFilePath = Path.Combine(this.enlistment.DotGitRoot, "objects", "info", "alternates");
        ...
        {
            string expectedHooksPath = Path.Combine(this.enlistment.DotGitRoot, "hooks");
            ...
            Dictionary<string, string> requiredSettings = new Dictionary<string, string>
            {
                ...
                { GitConfigSetting.CoreVirtualFileSystemName, Paths.ConvertPathToGitFormat(
                    Path.Combine(this.enlistment.DotGitRoot, "hooks", GVFSConstants.DotGit.Hooks.VirtualFileSystemName)) },
