...
namespace GVFS.Common.NamedPipes
{
    ...
    /// </summary>
    /// <remarks>
    /// This file contains message types that GVFS.Hooks needs access to
    /// (file-linked into GVFS.Hooks.csproj). For message types used only
    /// by the mount process, see GVFS.Common/NamedPipeMessages.
    /// </remarks>
        ...
        public static class HydrationStatus
        {
            ...
            public class Response
            {
                ...
                public string ToDisplayMessage()
                {
                    ...
                    int filePercent = this.TotalFileCount == 0 ? 0 : (100 * this.HydratedFileCount) / this.TotalFileCount;
                    int folderPercent = this.TotalFolderCount == 0 ? 0 : (100 * this.HydratedFolderCount) / this.TotalFolderCount;
